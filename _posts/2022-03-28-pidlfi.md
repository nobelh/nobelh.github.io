...
As shown in the following code, the `include` statement is used to copy into the `lfi.php` page, the contents of the file specified in the `lang` variable:
...
I've created a python script to automate the process and write the contents of the extracted PID files into an output file for offline review. You can find the code of the script **[here](https://github.com/nobelh/PID-Enumeration-by-LFI)**.

<h4>The parameters passed to the script are:</h4>
