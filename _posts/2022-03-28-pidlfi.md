...
The parameter passed to the scripts are:

<h4>URL:</h4> The web app URL including the vulnerable parameter 
<h4>Max PID Count:</h4> The maximum number of PIDs to try starting from 1
<h4>Proc File:</h4> Name of the file we want to read from inside the PID subdirectory
<h4>Output File:</h4> Name of the output file
